...
export default function AgencySignupPage() {
  ...
  // ── Format license key as user types (AFT8-XXXX-XXXX-XXXX) ──
  ...
  // ── Validate license key once fully entered (16 chars = AFT8-XXXX-XXXX-XXXX) ──
        ...
        <div className="bg-[#050609] border border-white/10 rounded-2xl p-8 shadow-2xl backdrop-blur-sm relative overflow-hidden">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-xl font-semibold text-white tracking-tight mb-2">
              Agency Partner Signup
            </h1>
            <p className="text-xs text-slate-400">
              Enter your details and agency license key to activate your account.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label
                ...
                className="block text-xs font-medium text-slate-300 ml-1"
              >
                Agency License Key<span className="text-red-500">*</span>
              </label>
              <div className={`relative group rounded-lg ${keyBorderColor}`}>
                ...
                <input
                  ...
                  id="licenseKey"
                  name="licenseKey"
                  placeholder="AFT8-XXXX-XXXX-XXXX"
                  value={licenseKey}
              ...
              <p className="text-[11px] text-slate-600 ml-1">
                Enter the license key provided by AlgoFinTech admin.
              </p>
            </div>
