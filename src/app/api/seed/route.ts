...
export async function GET() {
  try {
    ...
    const ALGORITHMS = [
      { slug: "forex-alpha-scalp-fx", name: "Alpha Scalp FX", description: "High-frequency scalping algorithm targeting major currency pairs during London overlap.", category: "Forex", roi: "+142%", drawdown: "8.4%", win_rate: "68%", status: "active", risk_level: "high", sharpe_ratio: 1.85, pairs: "XAUUSD" },
      { slug: "crypto-bitwave-ai", name: "BitWave AI", description: "Neural network model optimized for Bitcoin volatility patterns and trend reversals.", category: "Crypto", roi: "+284%", drawdown: "12.1%", win_rate: "54%", status: "active", risk_level: "high", sharpe_ratio: 2.10, pairs: "BTC/USD" },
      { slug: "stocks-equity-shield", name: "Equity Shield", description: "Long-short equity strategy focused on tech sector volatility reduction.", category: "Stocks", roi: "+45%", drawdown: "4.2%", win_rate: "72%", status: "active", risk_level: "low", sharpe_ratio: 2.40, pairs: "SPY/QQQ" },
      { slug: "futures-gold-trend-v2", name: "Gold Trend V2", description: "Automated system tracking macro trends in Gold and Silver futures.", category: "Futures", roi: "+88%", drawdown: "9.5%", win_rate: "62%", status: "active", risk_level: "medium", sharpe_ratio: 1.65, pairs: "GC/SI" },
      { slug: "forex-euro-impulse", name: "Euro Impulse", description: "Breakout strategy specifically designed for EUR/USD volatility.", category: "Forex", roi: "+76%", drawdown: "5.8%", win_rate: "65%", status: "active", risk_level: "medium", sharpe_ratio: 1.92, pairs: "EURUSD" },
      { slug: "crypto-ether-momentum", name: "Ether Momentum", description: "Captures strong momentum moves in Ethereum cross pairs.", category: "Crypto", roi: "+190%", drawdown: "15.4%", win_rate: "51%", status: "beta", risk_level: "high", sharpe_ratio: 1.45, pairs: "ETH/BTC" },
      { slug: "stocks-nasdaq-runner", name: "Nasdaq Runner", description: "Intraday trend following on QQQ and tech-heavy constituents.", category: "Stocks", roi: "+62%", drawdown: "7.1%", win_rate: "59%", status: "active", risk_level: "medium", sharpe_ratio: 1.70, pairs: "NQ/QQQ" },
      { slug: "futures-oil-swing-pro", name: "Oil Swing Pro", description: "Crude oil inventory news trading algorithm with tight risk control.", category: "Futures", roi: "+56%", drawdown: "6.3%", win_rate: "60%", status: "active", risk_level: "medium", sharpe_ratio: 1.55, pairs: "CL" },
      { slug: "forex-cable-breakout", name: "Cable Breakout", description: "GBP/USD breakout system utilizing London open volatility.", category: "Forex", roi: "+92%", drawdown: "10.1%", win_rate: "58%", status: "beta", risk_level: "high", sharpe_ratio: 1.38, pairs: "GBPUSD" },
      { slug: "crypto-defi-yield-hunter", name: "DeFi Yield Hunter", description: "Arbitrage algorithm working across major decentralized exchanges.", category: "Crypto", roi: "+310%", drawdown: "18.2%", win_rate: "75%", status: "active", risk_level: "high", sharpe_ratio: 2.25, pairs: "Multi-DEX" },
      { slug: "stocks-blue-chip-growth", name: "Blue Chip Growth", description: "Conservative growth strategy focusing on S&P 500 dividend payers.", category: "Stocks", roi: "+22%", drawdown: "3.1%", win_rate: "82%", status: "active", risk_level: "low", sharpe_ratio: 2.80, pairs: "SPX/DIA" },
      { slug: "futures-treasury-bond-arb", name: "Treasury Bond Arb", description: "Yield curve arbitrage trading on 10-year and 2-year notes.", category: "Futures", roi: "+18%", drawdown: "2.5%", win_rate: "92%", status: "active", risk_level: "low", sharpe_ratio: 3.10, pairs: "ZN/ZT" },
      { slug: "forex-yen-carrier", name: "Yen Carrier", description: "Carry trade strategy focused on USD/JPY and EUR/JPY interest differentials.", category: "Forex", roi: "+41%", drawdown: "12.5%", win_rate: "70%", status: "active", risk_level: "medium", sharpe_ratio: 1.50, pairs: "USDJPY/EURJPY" },
      { slug: "crypto-solana-speed", name: "Solana Speed", description: "Scalping algorithm optimized for Solana's block times.", category: "Crypto", roi: "+165%", drawdown: "14.3%", win_rate: "55%", status: "beta", risk_level: "high", sharpe_ratio: 1.60, pairs: "SOL/USD" },
      { slug: "stocks-small-cap-rocket", name: "Small Cap Rocket", description: "High volatility breakout strategy for Russell 2000 stocks.", category: "Stocks", roi: "+98%", drawdown: "16.5%", win_rate: "48%", status: "beta", risk_level: "high", sharpe_ratio: 1.20, pairs: "IWM/RTY" },
      { slug: "futures-agri-commodity-cycle", name: "Agri-Commodity Cycle", description: "Seasonal trading model for Wheat, Corn, and Soybeans.", category: "Futures", roi: "+34%", drawdown: "8.8%", win_rate: "65%", status: "active", risk_level: "medium", sharpe_ratio: 1.75, pairs: "ZW/ZC/ZS" },
      { slug: "forex-global-macro-fx", name: "Global Macro FX", description: "Long-term trend following based on central bank interest rate policies.", category: "Forex", roi: "+67%", drawdown: "11.2%", win_rate: "55%", status: "deprecated", risk_level: "medium", sharpe_ratio: 1.30, pairs: "G10 FX" },
      { slug: "crypto-bitcoin-trend-follower", name: "Bitcoin Trend Follower", description: "Classic Donchian channel strategy adapted for BTC/USD.", category: "Crypto", roi: "+112%", drawdown: "18.5%", win_rate: "45%", status: "deprecated", risk_level: "high", sharpe_ratio: 0.95, pairs: "BTC/USD" },
      { slug: "stocks-tech-sector-rotation", name: "Tech Sector Rotation", description: "Monthly rotation strategy moving between semiconductor and software ETFs.", category: "Stocks", roi: "+38%", drawdown: "6.1%", win_rate: "64%", status: "active", risk_level: "low", sharpe_ratio: 2.00, pairs: "SMH/IGV" },
      { slug: "futures-e-mini-scalper", name: "E-Mini Scalper", description: "Rapid fire execution on S&P 500 E-mini futures order flow.", category: "Futures", roi: "+104%", drawdown: "9.3%", win_rate: "72%", status: "active", risk_level: "medium", sharpe_ratio: 1.88, pairs: "ES" },
    ];
